...
#--------------NODE1-------------
  config.vm.define "rac1n1" do |node|  # node1
    ...
    config.vm.provider "virtualbox" do |vb|  # node1 customize
      ...
      # network
      # Public IP
      node.vm.network "private_network", ip: "192.168.0.111", virtualbox__intnet: true
      # Private Interconnect
      node.vm.network "private_network", ip: "10.10.10.111", virtualbox__intnet: true
  ...
  config.vm.define "rac1n2" do |node| # node2
    ...
    node.vm.network "private_network", ip: "10.10.10.112", virtualbox__intnet: true   # private interconnect
        ...
        config.vm.provider "virtualbox" do |vb|  # node2 customize
          # Network
          # Public IP
          node.vm.network "private_network", ip: "192.168.0.112", virtualbox__intnet: true
          # Private Interconnect
          node.vm.network "private_network", ip: "10.10.10.112", virtualbox__intnet: true
